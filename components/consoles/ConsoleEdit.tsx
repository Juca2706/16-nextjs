...
import {
    Type, Factory, Calendar, AlignLeft,
...
export default function ConsoleEdit({ consoleData }: { consoleData: any }) {
    ...
    const [preview, setPreview] = useState<string | null>(
        consoleData.image ? resolveAssetUrl(consoleData.image, "no-image.png") : null
    );
    ...
    useEffect(() => {
        if (state?.success) {
            toast.success("Consola actualizada", {
                description: "Los cambios tecnicos se guardaron con exito.",
            });
